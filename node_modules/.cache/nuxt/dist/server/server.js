...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "body{background-color:#ddc5b9;font-family:Montserrat,sans-serif}h1{font-size:42px;color:#bd5927}.centered{position:absolute;top:50%;left:50%;margin-right:-50%;transform:translate(-50%,-50%)}#maintenance-banner h1{position:absolute;margin-left:7%}#logo-container{display:flex;justify-content:center}#logo{max-height:65vh;max-width:70vw}#landing-links-container{display:flex;justify-content:center}.landing-link{margin:0 3em;font-size:32px}a,a:visited{text-decoration:none;color:inherit}a:hover{color:#c79984}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
const _d1734ffc = () => interopDefault(__webpack_require__.e(/* import() | pages/archi/index */ 2).then(__webpack_require__.bind(null, 27)));

const _3ef3d343 = () => interopDefault(__webpack_require__.e(/* import() | pages/photo/index */ 5).then(__webpack_require__.bind(null, 28)));

const _d4e0928c = () => interopDefault(__webpack_require__.e(/* import() | pages/archi/_slug */ 1).then(__webpack_require__.bind(null, 25)));

const _3d3d31fb = () => interopDefault(__webpack_require__.e(/* import() | pages/photo/_slug */ 4).then(__webpack_require__.bind(null, 26)));

const _043ac2ff = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 3).then(__webpack_require__.bind(null, 29)));
