...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "body{background-color:#ddc5b9;font-family:Montserrat,sans-serif}h1{font-size:42px;color:#bd5927}.centered{top:50%;left:50%;margin-right:-50%;transform:translate(-50%,-50%)}#maintenance-banner h1,.centered{position:absolute}#logo-container{display:flex;justify-content:center}#logo{max-height:65vh;max-width:70vw}#landing-links-container{display:flex;justify-content:center}.landing-link{margin:0 3em;font-size:32px}a,a:visited{text-decoration:none;color:inherit}a:hover{color:#c79984}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
